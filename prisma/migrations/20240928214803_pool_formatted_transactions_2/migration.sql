/*
  ...
  - You are about to drop the `PoolFormattedTransactionSave2` table. If the table is not empty, all the data it contains will be lost.

*/
-- DropTable
DROP TABLE "PoolFormattedTransactionSave2";
